...
class _AddNewTaskState extends State<AddNewTask> {
  ...
  _addNewTask() async {
    ...
    if (titleTodo.isEmpty) {
      ...
      MyResponse response = await TodoController.addNewTask(titleTodo, descTodo,_selectedDate.toIso8601String(),  statusTodo);
      ...
      if (response.success) {
        Fluttertoast.showToast(msg: 'Task added.', toastLength: Toast.LENGTH_LONG);
  ...
  void _confirmAddTask() {
    ...
    AlertDialog alert = AlertDialog(
      ...
      title: const Text('Confirm Add To Do', style: TextStyle(fontSize: 18),),
      content: const Text('Are you sure you want to add this to do task?', style: TextStyle(fontSize: 14)),
      actions: [
        cancelButton,
        continueButton,
      ],
